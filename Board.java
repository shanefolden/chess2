...
public class Board extends JPanel
{
  ...
  public void drawSpaces(Graphics g){
    for(int i = 0; i<7; i++){
      for(int j = 0; j<7; j++){
        Color squareColor = (i+j)%2 ==0 ? new Color(50,50,50) : new Color(200,200,200); 
        g.setColor(squareColor); 
        int xOffset = i == 0 || i == 7 ? 15 : 10;
        int yOffset = j == 0 || j == 7 ? 15 : 10;

        
        g.fillRect(i*113 +100 + xOffset, j*113+40+yOffset, SQUARE_LENGTH - xOffset, SQUARE_LENGTH -yOffset);
      }  
    }
  }
}   